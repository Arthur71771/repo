...
class Bomb {
    ...
    mul() {
        ...
        if (newCell && this.multiply >= 8) {
            ...
            var newBomb = new Bomb(newX, newY, 1);
    ...
    bomb() {
        ...
        if(newCell) {
            ...
            var newY = newCell[1];
            matrix[newY][newX] = 2
            var newBomb = new GrassEater(newX, newY, 1);
            grassEaterArr.push(newBomb);
        }
    }
}
...
class Zone {
    ...
    zoneH() {
        ...
        if (newCell) {
            ...
            var newZone = new Grass(newX, newY, 1);
            grassArr.push(newZone);
            this.multiply = 0;
        }
    }
}